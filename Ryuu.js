...
.on('exit', () => {
Ryuu.sendMessage(from, fs.readFileSync('./media/nulis/images/buku/setelahkiri.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: mek, caption: `Succes, Btw Jangan Malas Belajar Ya`})
...
.on('error', () => reply(mess.eror))
.on('exit', () => {
Ryuu.sendMessage(from, fs.readFileSync('./media/nulis/images/buku/setelahkanan.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: mek, caption: `Succes, Btw Jangan Malas Belajar Ya`})
...
.on('error', () => reply(mess.eror))
.on('exit', () => {
Ryuu.sendMessage(from, fs.readFileSync('./media/nulis/images/folio/setelahkiri.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: mek, caption: `Succes, Btw Jangan Malas Belajar Ya`})
...
.on('error', () => reply(mess.eror))
.on('exit', () => {
Ryuu.sendMessage(from, fs.readFileSync('./media/nulis/images/folio/setelahkanan.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: mek, caption: `Succes, Btw Jangan Malas Belajar Ya`})
